...
<?php $this->load->view("incluir/cuerpo");?>
	<h2> Crear Nuevo Plan de Cobertura</h2><br>
...
<table style="width:600px" border="0" cellspacing="3" cellpadding="0"  >
	<tr>
		<td>Estado:</td>
		<td colspan="3">
					<select name="txtEstado"	id="txtEstado" style="width: 480px;">				
	...
	<tr>
		<td>Rif:</td>
		<td colspan="3">
					<input name="txtRif" type="text" id="txtRif" style="width: 480px;">
		 </td>
	</tr>
	<tr>
		<td>Contratante:</td>
		<td colspan="3">
					<input name="txtOrganismo" type="text" id="txtOrganismo" style="width: 480px;">
		 </td>
	</tr>
	...
	<tr>
		...
		<td colspan="3">
					<input name="txtContacto" type="text" id="txtContacto" style="width: 480px;">
		 </td>
	</tr>
	...
	<div id="botones">
			<button name="Solicitar" onclick="Crear();">Crear Cobertura</button>
