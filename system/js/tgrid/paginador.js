...
Paginador = function(divPaginador, tabla, tamPagina,detalle) {
	...
	this.SetPagina = function(num) {
		...
		if(num == 1) {
			...
			this.divPaginadorAux.firstChild.rows[0].cells[1].style.visibility = "hidden";
			this.divPaginadorAux.firstChild.rows[0].cells[0].innerHTML = 'Mostrando ' + min + ' a ' + a + ' de ' + de + ' | Pagina ' + this.pagActual + ' De ' + this.paginas;
		} else {
			//this.miDiv.firstChild.rows[0].cells[1].style.display = "table-cell";
			this.divPaginadorAux.firstChild.rows[0].cells[1].style.visibility = "visible";
			this.divPaginadorAux.firstChild.rows[0].cells[0].innerHTML = 'Mostrando ' + min + ' a ' + a + ' de ' + de + ' | Pagina ' + this.pagActual + ' De ' + this.paginas;
		}

		if(num == this.paginas) {
			//this.miDiv.firstChild.rows[0].cells[3].style.display = "none";
			this.divPaginadorAux.firstChild.rows[0].cells[3].style.visibility = "hidden";
			this.divPaginadorAux.firstChild.rows[0].cells[0].innerHTML = 'Mostrando ' + min + ' a ' + a + ' de ' + de + ' | Pagina ' + this.pagActual + ' De ' + this.paginas;
		} else {
			//this.miDiv.firstChild.rows[0].cells[3].style.display = "table-cell";
			this.divPaginadorAux.firstChild.rows[0].cells[3].style.visibility = "visible";
			this.divPaginadorAux.firstChild.rows[0].cells[0].innerHTML = 'Mostrando ' + min + ' a ' + a + ' de ' + de + ' | Pagina ' + this.pagActual + ' De ' + this.paginas;
		}
	...
	this.Mostrar = function() {
		...
		this.divPaginadorAux.style.cssText = "float:left;width:70%;";
