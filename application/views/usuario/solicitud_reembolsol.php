...
<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/solicitud_reel.js"></script>
<script type="text/javascript" src="<?php echo __JSVIEW__ ?>tgrid/tgrid.js"></script>

<?php $this->load->view("incluir/cuerpo");?>
	<h2> Solicitud de Reembolso Por Laboratorio y consulta</h2><br>
    ...
    <ul>
      ...
      <li><a href="#tabs-2">Recepcion Faturas/Recibos</a></li>      
    </ul>	
		<div id='tabs-1' >																		
				<?php $this->load->view("usuario/frm/frmUsuarioReem");?>		
		</div>
		<div id='tabs-2'>
				<?php $this->load->view("usuario/frm/frmReembolsol");?>
		</div>		
	</div><br>
	<div id="botones">
