...
<table style="width:600px" border="0" cellspacing="3" cellpadding="0"  >
  ...
  <tr>
  	...
  	<td>
  		<input type="text" id ="txtConsultasD" name="txtConsultasD"  style="width: 180px;" value="0"  disabled="true"/>
  	</td>
  	<td >Consultas Retenidas:</td>
    <td align="right" >
      <input name="txtConsultasR"  type="text" id="txtConsultasR" style="width: 150px;" value="0"  disabled="true">
    </td>
  </tr>
