<table>
	<tr> 	
		...
		<td style="width: 100px;" align="left" colspan="5">
			...
			<select name="txtEstado"	id="txtEstado"style="" onblur="Organismos()">				
	...
	<tr>
		<td>Organismo :</td>
		<td>
			<select name="txtContratante"	id="txtContratante" style="width: 400px;">
				<option value='-----------'>-----------</option>
		...
		<td>Estatus :</td>
		<td>
			<select name="txtTipo"	id="txtTipo" style="width: 400px;">
