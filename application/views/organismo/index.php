...
<?php $this->load->view("incluir/cuerpo");?>
	<h2> Registrar Organismos</h2><br>
	<h3> Fecha y hora actual del Sistema <?php echo date("d/m/Y h:m:s");?></h3><br><br>

	<div>
		<table>
			<tr>
				<td style="width:220px">1. -Nombre del Organismo</td><td><input type="text" name="txtContratante" id="txtContratante"  style="width:250px;"/></td>
			</tr>
			<tr>
