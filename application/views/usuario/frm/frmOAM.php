 <table style="width:600px" border="0" cellspacing="3" cellpadding="0"  >
  <tr><td colspan="4">
    ...
    <td align="left"  >
      <input name="txtFechaE"  type="text" id="txtFechaE" style="width: 160px;">
    </td>
   </tr>
  <tr >
	...
	<td align="left"  colspan=3>
      <select name="txtTipoI" id="txtTipoI" style="width: 465px;" >
	    ...
	    <td align="left"  colspan=3 >
	      <textarea name="txtDiagnostico"  type="text" id="txtDiagnostico" style="width: 465px; height: 45px"></textarea>
	    </td>
	 </tr>
	    ...
	    <td align="left"  colspan=3 >
	      <textarea name="txtBreveInforme"  type="text" id="txtBreveInforme" style="width: 465px; height: 45px"></textarea>
	    </td>
	 </tr>
	...
	<input name="txtModulo"  type="hidden" id="txtModulo" style="width: 180px;" value="1">	
