...
<tr>
    <td style="width: 130px;">Fecha Factura:</td>
  ...
  <tr>
	...
	<tr>
     ...
     <tr>
      ...
      <input name="txtTitularc" type="text"style="width: 460px;" id="txtTitularc"  value="-">
    </td>
  </tr>
    <tr>
    <td>Banco </td>
    ...
    <tr>
      ...
      <td  colspan="3" align="left" readonly="readonly">
      <input name="txtCuenta" type="text"style="width: 460px;" id="txtCuenta" maxlength="20" onblur="Verificar_Cuenta(this.value);" value="-">
    </td>
  </tr>
