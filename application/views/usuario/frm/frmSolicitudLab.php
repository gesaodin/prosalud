...
<table style="width:600px" border="0" cellspacing="3" cellpadding="0"  >
  ...
  <tr>
  	<td>Laboratorio Dis:</td>
  	<td>
  		<input type="text" id ="txtExamenD" name="txtExamenD"  style="width: 180px;" value=""/>
  	</td>
  	<td >Laboratorio Ret:</td>
    <td align="right" >
      <input name="txtExamenR"  type="text" id="txtExamenR" style="width: 150px;" value="">
    </td>
  </tr>
